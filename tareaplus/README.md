# Tarea+ — marca, landing y app Android
...
El proyecto nativo está versionado en `app/android/` (appId `mx.tareaplus.app`, nombre
"Tarea+", iconos adaptativos y splash de marca ya generados). Los recursos de la ficha de
